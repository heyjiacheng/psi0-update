...
from pir2.experiment.trainer import Gr00tTrainer, ProfCallback
from pir2.experiment.utils import BestMetricCheckpointCallback, CheckpointFormatCallback
from pir2.model import MODEL_REGISTRY
from pir2.utils.initial_actions import INITIAL_ACTIONS_FILENAME, save_initial_actions
...
def run(config: Config):
    ...
    training_args = TrainingArguments(
        ...
        # Auto-disable tf32 on pre-Ampere GPUs (e.g. Quadro RTX 6000 = Turing,
        # compute_cap 7.5). HF's TrainingArguments rejects tf32=True there.
        # Ampere (8.0+, A100/A5000/A6000) and Ada (8.9, RTX 6000 Ada/4090) keep tf32.
        tf32=(
            config.training.tf32
