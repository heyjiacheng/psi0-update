...
from pir2.utils.initial_actions import INITIAL_ACTIONS_FILENAME, load_initial_actions
from pir2.utils.video_utils import get_frames_by_indices
...
class LeRobotEpisodeLoader:
    ...
    def _load_metadata(self) -> None:
        ...
        assert stats_path.exists(), (
            f"{stats_path} does not exist for {self.dataset_path}, please use pir2/data/stats.py to generate it"
        )
