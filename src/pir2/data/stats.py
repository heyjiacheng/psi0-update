...
Usage:
    python pir2/data/stats.py --dataset-path <dataset_path> --embodiment-tag <embodiment_tag>
    python pir2/data/stats.py --dataset-path <dataset_path> --embodiment-tag <embodiment_tag> --modality-config-path <config.py>
...
from pir2.data.dataset.lerobot_episode_loader import LeRobotEpisodeLoader
from pir2.data.state_action.action_chunking import EndEffectorActionChunk, JointActionChunk
from pir2.data.state_action.pose import EndEffectorPose, JointPose
from pir2.data.types import ActionRepresentation, ActionType, EmbodimentTag, ModalityConfig
from pir2.data.utils import to_json_serializable
