...
from pir2.eval.sim.env_utils import get_embodiment_tag_from_env_name
from pir2.eval.sim.wrapper.multistep_wrapper import MultiStepWrapper
from pir2.policy import BasePolicy
...
def get_simpler_env_fn(
    ...
    def env_fn():
        from pir2.eval.sim.SimplerEnv.simpler_env import register_simpler_envs
...
def get_libero_env_fn(
    ...
    def env_fn():
        from pir2.eval.sim.LIBERO.libero_env import register_libero_envs
...
def create_eval_env(
    ...
    if wrapper_configs.video.video_dir is not None:
        from pir2.eval.sim.wrapper.video_recording_wrapper import (
            VideoRecorder,
...
def create_gr00t_sim_policy(
    ...
    from pir2.policy.gr00t_policy import Gr00tPolicy, Gr00tSimPolicyWrapper

    if policy_client_host and policy_client_port:
        from pir2.policy.server_client import PolicyClient
